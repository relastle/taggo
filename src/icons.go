...
var extensionIconMap = map[string]Icon{
	...
	"audio":        {code: "\uf001", color: "cyan"},
	"avro":         {code: "\ue60b", color: ""},
	"bash":         {code: "\uf489", color: "yellow"},
	"c":            {code: "\ue61e", color: ""},
	"clj":          {code: "\ue768", color: ""},
	"coffee":       {code: "\uf0f4", color: "yellow"},
	"conf":         {code: "\ue615", color: ""},
	"cpp":          {code: "\ue61d", color: ""},
	"css":          {code: "\ue749", color: ""},
	"d":            {code: "\ue7af", color: ""},
	"dart":         {code: "\ue798", color: "magenda"},
	"db":           {code: "\uf1c0", color: ""},
	"diff":         {code: "\uf440", color: ""},
	"doc":          {code: "\uf1c2", color: ""},
	"docker":       {code: "\uf308", color: ""},
	...
	"epub":         {code: "\ue28a", color: ""},
	"erl":          {code: "\ue7b1", color: ""},
	"file":         {code: "\uf15b", color: "blue"},
	"fish":         {code: "\uf489", color: "yellow"},
	"font":         {code: "\uf031", color: ""},
	"gform":        {code: "\uf298", color: ""},
	"git":          {code: "\uf1d3", color: "yellow"},
	"go":           {code: "\ue626", color: "cyan"},
	"gruntfile.js": {code: "\ue74c", color: ""},
	"hs":           {code: "\ue777", color: ""},
	"html":         {code: "\uf13b", color: ""},
	"image":        {code: "\uf1c5", color: "red"},
	"iml":          {code: "\ue7b5", color: ""},
	"java":         {code: "\ue204", color: "yellow"},
	...
	"xls":          {code: "\uf1c3", color: "green"},
	"xml":          {code: "\ue619", color: "blue"},
	"yarn.lock":    {code: "\ue718", color: "yellow"},
	"yml":          {code: "\uf481", color: "red"},
	"zip":          {code: "\uf410", color: "black"},
	"zsh":          {code: "\uf489", color: "yellow"},
}
